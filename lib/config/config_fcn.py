...
tf.app.flags.DEFINE_string('pretrained_model', "E:\\2019code\image_m\Image_manipulation_detection-master\data\imagenet_weights\\resnet_v1_101.ckpt", "Pretrained network weights")
...
tf.app.flags.DEFINE_integer('rpn_batchsize', 200, "Total number of examples")
