...
tf.app.flags.DEFINE_boolean('USE_MASK', False, "resized to a square of POOLING_SIZE")

tf.app.flags.DEFINE_integer('batch_size', 64, "Network batch size during training")
tf.app.flags.DEFINE_integer('max_iters', 150000, "Max iteration")
...
tf.app.flags.DEFINE_float('rpn_train_nms_thresh', 0.3, "NMS threshold used on RPN proposals")
