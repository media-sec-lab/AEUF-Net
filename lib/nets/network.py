...
class Network(object):
    ...
    def _add_losses(self, sigma_rpn=3.0):
        with tf.variable_scope('loss_' + self._tag):
            # RPN, class loss
            # print('22222222222222223333333333333rpn_cls_score', self._predictions['rpn_cls_score_reshape'])
            rpn_cls_score = tf.reshape(self._predictions['rpn_cls_score_reshape'], [-1, 2])
            rpn_label = tf.reshape(self._anchor_targets['rpn_labels'], [-1])
            # print('2222222222222222333333333333311rpn_label', rpn_label)
            ...
            # print('2222222222222222333333333333311rpn_cls_score', rpn_cls_score)
            # print('2222222222222222333333333333311rpn_label', rpn_label)
            # print('2222222222222222333333333333311rpn_bbox_pred', rpn_bbox_pred)
            # print('2222222222222222333333333333311rpn_bbox_targets', rpn_bbox_targets)
            # print('2222222222222222333333333333311bbox_pred', bbox_pred)
            # print('2222222222222222333333333333311bbox_targets', bbox_targets)
            # print('2222222222222222333333333333311_score', cls_score)
            # print('2222222222222222333333333333311label', label)
            # print(aaaa)
