...
from lib.nets.RGB_N import resnetv3
# from lib.nets.b1_fuse_pixelat_reverse import resnetv3
# from lib.nets.b1_fuse_sc1aAddcfe_1 import resnetv3
# from lib.nets.b1_zsjz import resnetv3
...
class Train:
    def __init__(self):
        ...
        # output_dir = 'b1a_0817'
        # output_dir = 'b1_new_x2d_07_0921_n110'
        # output_dir = 'b1_are_xa_0925_256_n120'
        # output_dir = 'b1_128_07_n110_1219'
        # output_dir = 'b1_fuse_1cbam_128_07_n110'
        output_dir = 'RGB_N_128_07_n110'
    ...
    def train(self):
        ...
        with sess.graph.as_default():
            ...
            # optimizer = tf.train.RMSPropOptimizer(learning_rate=lr,centered=True)
        ...
        while iter < cfg.FLAGS.max_iters + 1:
            ...
            # if iter % 1000 == 0:
            #     sess.run(tf.assign(lr, cfg.FLAGS.learning_rate * 0.96))
            # if iter == 60000 + 1:
            ...
            if iter == 1:
                ...
                worksheet.write(0,4, label = 'loss_total')
                worksheet.write(0,5, label = 'iteration')
            ...
            if iter % cfg.FLAGS.snapshot_iterations == 0:
                ...
                tabsheet.write(k, 4, loss_total/cfg.FLAGS.snapshot_iterations)
                tabsheet.write(k, 5, iter)
